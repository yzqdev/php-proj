      ...
      this.appFetch({
        ...
        .then(data => {
          if (data.errors) {
            ...
            // logo size
            // 行数
            this.imghangshus = data.readdata._data.set_site.img_hangshu;
            this.htmlapp = data.readdata._data.set_site.site_htmlapp;
            this.siteTheme = data.readdata._data.set_site.site_skin;
            this.numberimgapp[0].textrule = this.siteTheme === 1
              ? "尺寸：80px*80px"
              : "尺寸：80px*80px";

            this.numberimgapp[0].imageUrl = data.readdata._data.set_site.site_img0;
            this.numberimgapp[1].imageUrl =
              data.readdata._data.set_site.site_img1;
            this.numberimgapp[2].imageUrl =
              data.readdata._data.set_site.site_img2;
            // icon
            this.numberimgapp[3].imageUrl =
              data.readdata._data.set_site.site_img3;
            this.numberimgapp[4].imageUrl =
              data.readdata._data.set_site.site_img4;
            this.numberimgapp[5].imageUrl =
              data.readdata._data.set_site.site_img5;
            this.numberimgapp[6].imageUrl =
              data.readdata._data.set_site.site_img6;
            this.numberimgapp[7].imageUrl =
              data.readdata._data.set_site.site_img7;
            this.numberimgapp[8].imageUrl =
              data.readdata._data.set_site.site_img8;
            this.numberimgapp[9].imageUrl =
              data.readdata._data.set_site.site_img9;
            ...
            if (this.imghangshus == 5) {
              this.imgHangshu = 5;
            } else if (this.imghangshus == 4) {
              this.imgHangshu = 4;
            } else {
              this.imgHangshu = 1;
            }
