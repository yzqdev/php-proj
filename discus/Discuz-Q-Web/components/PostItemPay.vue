<template>
  <div class="add-padding-line">
    <div class="post-container">
      ...
      <div class="post-header">
        ...
        >
          ...
          <span
            ...
            class="admin"
          >
            {{ item.user.groups[0].isDisplay ? `(${item.user.groups[0].name})` : "" }}
          </span>
        </nuxt-link>
        <!-- 回答状态 -->
        <div
      ...
      <!-- 帖子主体内容 -->
      <div v-if="item.firstPost" class="post-content">
        <!-- 首贴-->
        <div class="first-post" @click.self="toDetail">
          ...
          <div class="first-post-desc" @click="onClickContent">
            <div class="first-post-desc__tips">
              ...
              <img
                v-if="
                  (parseFloat(item.price) > 0 || parseFloat(item.attachmentPrice) > 0)
                "
            ...
            <!-- 仅仅帖子有标题 -->
            <p v-if="item.type === 1" class="content">{{ item.title }}</p>
            <!-- 内容展示 ，没有标题就用内容展示-->
            <p
              v-else
              class="content"
      ...
      <div class="post-footer">
        <div class="time">
          <template v-if="item.createdAt">
            {{ item.isDraft ? $t("topic.saveAt") : $t("topic.publishAt") }}
          ...
          .then(
            () => {
              this.$message.success(
                isLiked
                  ? this.$t('discuzq.msgBox.likeSuccess')+this.$t('discuzq.msgBox.likeSuccess')
