  ...
  <div v-loading="loading" class="myprofile">
    <div v-if="userInfo" class="myprofile-c" style="padding-bottom:0px">
      <div class="myprofile-top mtop">
        ...
        <div class="usr">
          <span class="usrname">
            {{ userInfo.username }}
            <span v-if="userInfo && userInfo.isReal" class="iden ide">
              <svg-icon type="auth" class="auth-icon auth" />
    ...
    >
      <div :class="{ profileborder: true, pborder: !isNameModify }">
        ...
        <div v-show="!isNameModify" class="myprofile-btom2">
          ...
          >
            <form class="form">
              <el-input
                ...
                class="passbtom"
              />
              <el-button type="primary" class="ebutton" @click="nameSub">{{
          ...
          >
            <form style="height:221px;">
              ...
              <div class="confirmbtn">
                <div class="allbtn">
                  <el-button class="comfirm" type="small" @click="sigComfirm">{{
                    this.$t("report.confirm")
                  }}</el-button>
                  <el-button class="cancel" type="small" @click="signModify">{{
        ...
        >
          <form class="form">
            ...
            <el-input
              ...
              class="passbtom"
            />
            <el-button type="primary" class="ebutton" @click="newVerify">{{
          ...
          >
            <form class="form">
              ...
              <el-input
                ...
                class="passbtom"
              />
              <el-button type="primary" class="ebutton" @click="dingphon">{{
                $t("profile.submitchange")
              }}</el-button>
            </form>
          </el-dialog>
    ...
    >
      <div class="profileborder paddingbottom">
        <div class="myprofile-top">
        ...
        <div v-show="!isPassModify" class="myprofile-btom2">
          {{
            userInfo && userInfo.hasPassword
              ? $t("profile.isset")
          ...
          <div v-if="userInfo && userInfo.hasPassword">
            ...
            >
              <form class="form">
                ...
                <el-button type="primary" class="ebutton" @click="passSub">{{
                  $t("profile.submitchange")
                }}</el-button>
              </form>
            </el-dialog>
          ...
          <div v-else>
            ...
            >
              <form class="form">
                ...
                <el-button type="primary" class="ebutton" @click="passSub2">{{
                  $t("modify.submit")
                }}</el-button>
              </form>
            </el-dialog>
    ...
    <div
      v-if="
        userInfo && forums && forums.passport && forums.passport.oplatform_close
      "
    ...
    >
      <div class="profileborder paddingbottom">
        ...
        <div class="myprofile-btom2 margintop">
          {{
        ...
        <div
          v-if="isWechatModify && userInfo && !userInfo.wechat"
          class="wehcat-bind"
        >
          <el-dialog
    ...
    >
      <div class="profileborder">
        ...
        <div v-show="!isRealModify" class="myprofile-btom2 myprofile-btom3">
          {{
          ...
          >
            <form class="form">
              ...
              <el-input
                ...
                class="passbtom"
              />
              <el-button type="primary" class="ebutton" @click="realSub">{{
                $t("profile.comfirmsubmit")
              }}</el-button>
            </form>
          </el-dialog>
        </div>
