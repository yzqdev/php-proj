...
#[OA\OpenApi(
    ...
    tags: [
        new OA\Tag(name: 'Health', description: 'Health 相关接口'),
        new OA\Tag(name: 'Auth', description: 'Auth 相关接口'),
        new OA\Tag(name: 'Articles', description: 'Articles 相关接口'),
        new OA\Tag(name: 'Activities', description: 'Activities 相关接口'),
    ],
