...
use Yzqde\Playground\Util\FileConst;
...
<head>
    <meta charset="UTF-8">
    <title>Learn Api document</title>
...
HTML;
    ...
    private function scanSpec(): object
    {
        ...
        try {
            $scanPaths = [
                realpath(FileConst::CONTROLLER_DIR),realpath(FileConst::SCHEMA_DIR), ];

            return (new \OpenApi\Generator())->generate($scanPaths);
        } finally {
