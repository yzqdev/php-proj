      ...
      this.appFetch({
        ...
        .then(data => {
          if (data.errors) {
            ...
            // 提问关闭时置灰付费模式data.readdata._data.set_site.site_ask
            if (data.readdata._data.set_site.site_ask.value == 1) {
              this.disabledask = true;
            } else {
              this.disabledask = false;
            }
            // logo size
            ...
            this.siteWeixinapp = data.readdata._data.set_site.site_weixinapp;
            this.siteWeixinkefu = data.readdata._data.set_site.site_weixinkefu;
            this.siteAsk = data.readdata._data.set_site.site_ask && data.readdata._data.set_site.site_ask[0].value;
            this.sitePinglun = data.readdata._data.set_site.site_pinglun;
            this.sitePinglunzhiding = data.readdata._data.set_site.site_pinglunzhiding;
            ...
            this.numberimg[4].imageUrl =
              data.readdata._data.set_site.site_gongzhonghao_logo;
            this.numberimg[5].imageUrl =
              data.readdata._data.set_site.site_xiaochengxu_logo;
            this.numberimg[6].imageUrl =
              data.readdata._data.set_site.site_kefuyi_logo;
            this.numberimg[7].imageUrl =
              data.readdata._data.set_site.site_kefuer_logo;
            ...
            if (this.sitePinglun == 1) {
              this.pinglun = 1;
            } else {
              this.pinglun = 2;
            }
            if (this.sitePinglunzhiding == 1) {
              this.pinglunzhiding = 1;
            } else if (this.sitePinglunzhiding == 2) {
              this.pinglunzhiding = 2;
            } else {
              this.pinglunzhiding = 3;
            }
            ...
            // }
            // 新的关闭站点
            this.ask = data.readdata._data.set_site.site_ask;
            ...
            this.getScaleImgSize(this.numberimg[4].imageUrl, {
              width: 140,
              height: 140
            }).then(res => {
              this.numberimg[4].imgWidht = res.width;
              this.numberimg[4].imgHeight = res.height;
            });
            this.getScaleImgSize(this.numberimg[5].imageUrl, {
              width: 140,
              height: 140
            }).then(res => {
              this.numberimg[5].imgWidht = res.width;
              this.numberimg[5].imgHeight = res.height;
            });
            this.getScaleImgSize(this.numberimg[6].imageUrl, {
              width: 140,
              height: 140
            }).then(res => {
              this.numberimg[6].imgWidht = res.width;
              this.numberimg[6].imgHeight = res.height;
            });
            this.getScaleImgSize(this.numberimg[7].imageUrl, {
              width: 140,
              height: 140
            }).then(res => {
              this.numberimg[7].imgWidht = res.width;
              this.numberimg[7].imgHeight = res.height;
            });
          }
        })
        .catch(error => {});
    ...
    deleteImage(file, index, fileList) {
      ...
      switch (index) {
        ...
        case 3:
          ...
          break;
        case 4:
          type = "gongzhonghao_logo";
          break;
        case 5:
          type = "xiaochengxu_logo";
          break;
        case 6:
          type = "kefuyi_logo";
          break;
      ...
      this.appFetch({
        ...
        data: {
          data: [
            ...
            {
              attributes: {
                key: "site_pinglunzhiding",
                value: this.pinglunzhiding,
                tag: "default"
              }
            },
            {
