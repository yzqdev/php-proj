...
class ColumnSerializer extends AbstractSerializer
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $list = Column::query()->where('parentid',$parentid)->orderBy('sort')->get();
    ...
    {
        $searchIds = Column::query()->where('id', $id)->orWhere('parentid', $id)->orderBy('id')->pluck('id');
