...
class ListColumnsController extends AbstractListController
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function data(ServerRequestInterface $request, Document $document)
    {
        ...
        /*if ($actor->exists && isset($filter['createThread']) && $filter['createThread']) {
            $query->whereNotIn('id', Column::getIdsWhereCannot($actor, 'createThread'));
        } else {
            $query->whereNotIn('id', Column::getIdsWhereCannot($actor, 'viewThreads'));
        }*/
