...
class Post extends DzqModel
{
    ...
    public function setContentAttribute($value)
    {
        if (blank($value) && $this->is_first) {
            $defaultContent = [
                ...
                Thread::TYPE_OF_HAIBAO => trans('post.default_content.image'),
    ...
    {
        return $this->hasMany(Attachment::class, 'type_id')->whereIn('type', [Attachment::TYPE_OF_IMAGE,5])->orderBy('order');
    }
