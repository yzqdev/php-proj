...
class Thread extends DzqModel
{
    ...
    //const TYPE_OF_QUAN = 7; // 圈子
    const TYPE_OF_QUAN = 10; // 圈子
    
    const TYPE_OF_QUANTIE = 11; // 课贴
    
    const TYPE_OF_HAIBAO = 8; // 海报图片
    
    const TYPE_OF_KE = 12; // 课程
    
    const TYPE_OF_KETIE = 13; // 课贴
    
    const TYPE_OF_ASK = 14; // 提问 2022-10-20
    ...
    public $threadDic = [
        self::TYPE_OF_TEXT => '帖子',
        self::TYPE_OF_LONG => '文章',
        self::TYPE_OF_VIDEO => '视频',
        self::TYPE_OF_IMAGE => '图片',
        self::TYPE_OF_AUDIO => '语音',
        self::TYPE_OF_QUESTION => '问答',
        self::TYPE_OF_GOODS => '商品',
        self::TYPE_OF_HAIBAO => '海报',
        self::TYPE_OF_QUAN => '圈子',
        self::TYPE_OF_QUANTIE => '圈贴',
        self::TYPE_OF_KE => '课程',
        self::TYPE_OF_KETIE => '课贴',
        self::TYPE_OF_ASK => '提问',
    ];
