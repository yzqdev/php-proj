    ...
    <div v-if="total2 > 0">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <span
              v-if="scope.row.change_type === 100 || scope.row.change_type === 110"
  ...
  methods: {
    ...
    statusFormat2(row) {
      switch (row.change_type) {
        ...
        case 100: return this.$t('profile.redpacketpay');
        case 101: return this.$t('profile.redpacketfreeze');
        case 102: return this.$t('profile.redpacketpayincome');
        case 103: return this.$t('profile.redpacketfreezeback');
        case 104: return this.$t('profile.textPostAbnormal');
        case 110: return this.$t('profile.longredpacketpay');
        case 111: return this.$t('profile.longredpacketfreeze');
        case 112: return this.$t('profile.longredpacketpayincome');
        case 113: return this.$t('profile.longredpacketfreezeback');
        case 114: return this.$t('profile.longTextPostAbnormal');
        case 120: return this.$t('profile.offerewardpay');
        case 121: return this.$t('profile.offerewardbalanceback');
        case 122: return this.$t('profile.offerewardbalancehalves');
        case 123: return this.$t('profile.offerewardbalancehalvesbylike');
        case 124: return this.$t('profile.offerewardPostAbnormal');
        default: return '未知状态';
      }
    },
    // 金额格式化
