...
export default {
  ...
  core: {
    ...
    permission_denied2: '您所在的用户组，暂无权限访问当前页面',
    permission_denied3: '无权限查看',
    permission_denied4: '您没有权限查看本页面内容',
    ...
    registerValidate: '账号审核中',
    validateReject: '账号未通过审核',
    ...
    page_permission_denied: '页面无权限查看',
    page_permission_denied_detail: '您访问的页面暂无权限查看，请联系管理员'
  },
  // 发布页
  post: {
  ...
  topic: {
    ...
    poster: '海报',
    cancelPoster: '取消海报',
    successPoster: '设置海报成功',
    cancelSuccessPoster: '已经取消海报',
    pinglun:'评论',
    cancelPinglun:'取消评论',
    successPinglun: '设置评论成功',
    cancelSuccessPinglun: '已经取消评论',
    original:'原创',
    cancelOriginal:'取消原创',
    stickyoriginalSuccess: '设置原创成功',
    cancelSuccessOriginal: '已经取消原创',
    originalsticky:'原创',
    sticky: '置顶',
    shuaxinsticky: '刷新置顶',
    cancelSticky: '取消置顶',
  ...
  permission: {
    viewThreads: '查看主题列表',
    canBeAsked: '允许提问',
    canBeAsked_money: '允许提问最低价格{lowPrice}元',
    canBeOnlooker: '设置围观',
    canBeReward: '允许被打赏',
    createThread_0_position: '允许发布文本位置',
    createThread_0_redPacket: '允许发布文本红包',
    createThread_0_anonymous: '允许发布文本匿名',
    createThread_1_position: '允许发布帖子位置',
    createThread_1_redPacket: '允许发布帖子红包',
    createThread_1_anonymous: '允许发布帖子匿名',
    createThread_2_position: '允许发布视频位置',
    createThread_2_anonymous: '允许发布视频匿名',
    createThread_3_position: '允许发布图片位置',
    createThread_3_anonymous: '允许发布图片匿名',
    createThread_4_position: '允许发布语音位置',
    createThread_4_anonymous: '允许发布语音匿名',
    createThread_5_position: '允许发布问答位置',
    createThread_5_anonymous: '允许发布问答匿名',
    createThread_6_position: '允许发布商品位置',
    createThread_6_anonymous: '允许发布商品匿名',
    createThread: '发布主题',
    createThread_0: '发布文本',
    createThread_1: '发布帖子',
    createThread_2: '发布视频',
    ...
    createThread_5: '发布问答',
    createThread_6: '发布商品',
    thread_editOwnThreadOrPost: '编辑发布的主题或回复',
    thread_hideOwnThreadOrPost: '删除发布的主题或回复',
    ...
    other_canInviteUserScale: '可邀请其他用户',
  ...
  profile: {
    ...
    redpacketpay: '文字帖红包支出',
    redpacketfreeze: '文字帖红包冻结',
    redpacketpayincome: '文字帖红包收入',
    redpacketfreezeback: '文字帖红包冻结返还',
    textPostAbnormal: '文字帖订单异常返现',
    longredpacketpay: '长文帖红包支出',
    longredpacketfreeze: '长文帖红包冻结',
    longredpacketpayincome: '长文帖红包收入',
    longredpacketfreezeback: '长文帖红包冻结返还',
    longTextPostAbnormal: '长文帖订单异常返现',
    offerewardpay: '悬赏问答收入',
    offerewardbalanceback: '悬赏帖过期-剩余悬赏金额返回',
    offerewardbalancehalves: '悬赏帖过期-平分剩余悬赏金额',
    offerewardbalancehalvesbylike: '悬赏帖过期-按点赞数比例分配剩余悬赏金额',
    offerewardPostAbnormal: '问答贴订单异常返现',
    tobereviewed: '待审核',
