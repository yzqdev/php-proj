...
')
     ...
     */ 
         ...
         * 
         *
         * @see \Catch\Support\Macros\Collection::toOptions()
         * @static 
         */ 
        public static function toOptions()
        {
                        return \Illuminate\Support\Collection::toOptions();
        }
                    /**
         * 
         *
         * @see \Catch\Support\Macros\Collection::toTree()
         * @param int $pid
         * @param string $pidField
         * @param string $child
         * @static 
         */ 
        public static function toTree($pid = 0, $pidField = 'parent_id', $child = 'children')
        {
                        return \Illuminate\Support\Collection::toTree($pid, $pidField, $child);
        }
                    /**
         * 
         *
         * @see \Catch\Support\Macros\Collection::export()
         * @param array $header
         * @static 
         */ 
        public static function export($header)
        {
                        return \Illuminate\Support\Collection::export($header);
        }
                    /**
         * 
         *
         * @see \Catch\Support\Macros\Collection::download()
         * @param array $header
         * @static 
         */ 
        public static function download($header)
        {
                        return \Illuminate\Support\Collection::download($header);
        }
     ...
     */ 
         ...
         * 
         *
         * @see \Catch\Support\Macros\Blueprint::createdAt()
         * @static 
         */ 
        public static function createdAt()
        {
                        return \Illuminate\Database\Schema\Blueprint::createdAt();
        }
                    /**
         * 
         *
         * @see \Catch\Support\Macros\Blueprint::updatedAt()
         * @static 
         */ 
        public static function updatedAt()
        {
                        return \Illuminate\Database\Schema\Blueprint::updatedAt();
        }
                    /**
         * 
         *
         * @see \Catch\Support\Macros\Blueprint::deletedAt()
         * @static 
         */ 
        public static function deletedAt()
        {
                        return \Illuminate\Database\Schema\Blueprint::deletedAt();
        }
                    /**
         * 
         *
         * @see \Catch\Support\Macros\Blueprint::status()
         * @param mixed $default
         * @static 
         */ 
        public static function status($default = 1)
        {
                        return \Illuminate\Database\Schema\Blueprint::status($default);
        }
                    /**
         * 
         *
         * @see \Catch\Support\Macros\Blueprint::creatorId()
         * @static 
         */ 
        public static function creatorId()
        {
                        return \Illuminate\Database\Schema\Blueprint::creatorId();
        }
                    /**
         * 
         *
         * @see \Catch\Support\Macros\Blueprint::unixTimestamp()
         * @static 
         */ 
        public static function unixTimestamp()
        {
                        return \Illuminate\Database\Schema\Blueprint::unixTimestamp();
        }
                    /**
         * 
         *
         * @see \Catch\Support\Macros\Blueprint::parentId()
         * @static 
         */ 
        public static function parentId()
        {
                        return \Illuminate\Database\Schema\Blueprint::parentId();
        }
                    /**
         * 
         *
         * @see \Catch\Support\Macros\Blueprint::sort()
         * @static 
         */ 
        public static function sort()
        {
                        return \Illuminate\Database\Schema\Blueprint::sort();
        }
...
namespace  { 
             ...
             * 
             *
             * @see \Catch\Support\Macros\Builder::whereLike()
             * @param mixed $filed
             * @param mixed $value
             * @static 
             */ 
            public static function whereLike($filed, $value)
            {
                                return \Illuminate\Database\Eloquent\Builder::whereLike($filed, $value);
            }
             
                /**
             * 
             *
             * @see \Catch\Support\Macros\Builder::quickSearch()
             * @param array $params
             * @static 
             */ 
            public static function quickSearch($params = [])
            {
                                return \Illuminate\Database\Eloquent\Builder::quickSearch($params);
            }
             
                /**
             * 
             *
             * @see \Catch\Support\Macros\Builder::tree()
             * @param string $id
             * @param string $parentId
             * @param mixed $fields
             * @static 
             */ 
            public static function tree($id, $parentId, ...$fields)
            {
                                return \Illuminate\Database\Eloquent\Builder::tree($id, $parentId, ...$fields);
            }
